...
df_Azores_Jan = pd.read_csv('Azores_net_January.csv')
df_NE_Atlantic = pd.read_csv('NE_Atlantic.csv')
df_NE_Atlantic.dropna(inplace=True)
df_Brazil_34 = pd.read_csv('Brazil_34.csv')
#df_Brazil_34.dropna(inplace=True)
df_Brazil_23 = pd.read_csv('Brazil_23.csv')
#df_Brazil_23.dropna(inplace=True)
df_Caribbean = pd.read_csv('Caribbean.csv')
#df_Caribbean.dropna(inplace=True)
df_Japan = pd.read_csv('Japan.csv')
#df_Brazil_23.dropna(inplace=True)
df_Panama = pd.read_csv('Panama.csv')
df_SE_Atlantic = pd.read_csv('SE_Atlantic.csv')
df_Arabian = pd.read_csv('Arabian.csv')
df_California = pd.read_csv('California.csv')
df_Ross_Sea = pd.read_csv('Antarctica.csv')
df_Arctic = pd.read_csv('Arctic.csv')
df_Atlantic_Current = pd.read_csv('Atlantic_Current.csv')
df_Labrador = pd.read_csv('Labrador.csv')

###---------------------------------- read csv data foramecogenie ----------------------------------------------------###
df_phyto = pd.read_csv('Total_phyto_genie.csv')
df_sigma2pal09 = pd.read_csv('sigma2pal09_abundance.csv')				
###------------------------------ BIOTRANS 47N ----------------------------------------------------###
